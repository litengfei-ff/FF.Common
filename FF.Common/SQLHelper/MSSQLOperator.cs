...
namespace FF.Common.SQLHelper
{
    ...
    public class MSSQLOperator
    {
        ...
        public MSSQLOperator()
        {
            string connStr = @"server=.\sqlexpress;uid=sa;pwd=123456;database=manager;pooling=true;min pool size=5;max pool size=100;";
